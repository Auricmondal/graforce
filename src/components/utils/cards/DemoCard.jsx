...
const DemoCard = ({ subsection, index, isReversed, isStraight = false }) => {
  ...
  return (
    ...
    >
      {/* Content Section */}
      <div
        className={`w-full md:w-[63%] h-auto rounded-2xl flex flex-col justify-center items-center lg:items-start gap-6 py-10 px-8 text-center lg:text-left order-1 lg:order-none`}
        style={{
          background:
      ...
      >
          ...
          <div>
            ...
            {/* Grid of Points */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-8 mt-4 w-full ">
