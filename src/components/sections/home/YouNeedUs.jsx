    ...
    <SectionWrapper sectionClassName="bg-cst-neutral-1">
      <div ref={sectionRef} className="flex items-start h-fit md:h-screen">
        <CardWrapper
          ...
          color="dark"
          align="custom"
          className="p-2 gap-2 h-full min-h-screen items-start" // changed: allow inner columns to stretch so justify-between works
        >
          ...
          <div className="hidden md:grid grid-cols-2 w-full h-full">
            ...
            >
              ...
              <div className="">
                <h3
                  ref={needRef}
                  className="text-white/10 font-bold text-sm lg:text-xl xl:text-2xl pt-[100px] sm:pt-0"
                  data-sector="0"
                  // No dangerouslySetInnerHTML here, handled by GSAP
                />
                <div className="pt-6 w-full">
                  <PrimaryButton className="bg-cst-neutral-1 text-black rounded-xl py-2 px-6 w-full text-sm md:text-base">
                    Learn More
                  </PrimaryButton>
                </div>
              </div>
