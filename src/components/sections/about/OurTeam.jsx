      ...
      <SectionWrapper sectionClassName="bg-cst-neutral-1">
        ...
        >
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <a>
              <p className="text-center text-cst-neutral-5 underline hover:text-primary transition-colors duration-300 ease-in-out cursor-pointer">
                Explore More with Our News
              </p>
            </a>
          </div>
